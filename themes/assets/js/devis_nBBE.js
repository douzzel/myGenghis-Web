...
$(".pro-search").autocomplete({
  ...
  select: function(event, ui) {
    ...
    document.getElementById('representant_legal').value = ui.item.representant_legal_id;
    document.getElementById('representant_legal_search').value = ui.item.representant_legal_name;
    document.getElementById("forme_juridique_select").value = ui.item.forme_id;
...
function addRow() {
    ...
    var pdets = pid.split("|");
    bbe = (pdets.length == 13 || pdets.length == 14);
    xBBE = bbe ? 2 : 0;

    if (pdets.length != 11 && pdets.length != 12 && !bbe)
      return;
    var table = document.getElementById("tableauProduits");
...
function saveDataPost(event, draft = false) {
    ...
    if(choix_partic == 'true'){
        var save_nom = document.getElementById("c_lname").value;
        var save_prenom = document.getElementById("c_fname").value;
        var save_civilite = document.getElementById("c_civilite").value;
        var save_addresse = document.getElementById("c_address").value;
        var save_addresse_complement = document.getElementById("c_address_complement").value;
        var save_ville = document.getElementById("c_town").value;
        var save_cp = document.getElementById("c_pcode").value;
        var save_pays = document.getElementById("c_country").value;
        var save_email = document.getElementById("c_email").value;
        document.getElementById("db_save_estim_pln").value = save_nom;
        document.getElementById("db_save_estim_pfn").value = save_prenom;
        document.getElementById("db_save_estim_civ").value = save_civilite;
        document.getElementById("db_save_estim_adr").value = save_addresse;
        document.getElementById("db_save_estim_adr_comp").value = save_addresse_complement;
        document.getElementById("db_save_estim_twn").value = save_ville;
        document.getElementById("db_save_estim_zip").value = save_cp;
        document.getElementById("db_save_estim_cty").value = save_pays;
        document.getElementById("db_save_estim_eml").value = save_email;
      }
    ...
    if (search[0] == "?TI") {
      ...
      $.ajax({
        ...
        success: function (data) {
          ...
          document.getElementById('representant_legal').value = data[0].representant_legal_id;
          document.getElementById('representant_legal_search').value = data[0].representant_legal_name;
          document.getElementById("forme_juridique_select").value = data[0].forme_id;
        }
      });
    }
  }
