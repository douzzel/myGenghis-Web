<?php
$tplAccess = new Template;
$tplAccess->setFile('access', './account/componants/access.html');
...
if(UTILS::getFunction('API_KEYS_GOOGLE_MAP') != null){
    $tplAccess->bloc('IF_IS_API_KEY_GOOGLE_MAP');
}
...
$PAGES = $tplAccess->construire('access');
?>
