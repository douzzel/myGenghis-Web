...
$( document ).ready( function(){
	...
	var signupFormSendingButton = 'Envoi en cours…';
	var signupFormSuccess = 'You have been added to our list!';
	var signupFormError = 'Une erreur s\'est produite, veuillez réessayer.';
	var signupFormSubscribed ='You are already subscribed to our list';
	var signupFormFillFields = 'Veuillez remplir les champs obligatoires.';
	var signupFormValidEmail = 'Veuillez saisir un email valide.';

	// Contact specific class
	// references and messages
	var contactForm = '.contact-form';
	var contactRequired = '.required-field';
	var contactFormSending = 'Veuillez patienter.';
	var contactFormSendingButton = 'Envoi en cours…';
	var contactFormSuccess = 'Merci, votre email a été reçu !';
	var contactFormError = 'Une erreur s\'est produite, veuillez réessayer.';
	var contactFormFillFields = 'Veuillez remplir les champs obligatoires.';
	var contactFormValidEmail = 'Veuillez saisir un email valide.';
