...
/**
* myGenghis Open-Code V2.5.3
* myGenghis | support@mygenghis.com
* https://mygenghis.com
*/
//TFM version
define('VERSION', '2.5.3');
//Application Title
define('APP_TITLE', 'Open-Code');
// --- EDIT BELOW CONFIGURATION CAREFULLY ---
// customized config file exists, so use it
...
sleep(1);
/*
// use PHP native "password_verify" function (don't forget to uncomment the "else > error" if this is used!) :
if(function_exists('password_verify')) {
if (isset($auth_users[$_POST['fm_usr']]) && isset($_POST['fm_pwd']) && password_verify($_POST['fm_pwd'], $auth_users[$_POST['fm_usr']]) && verifyToken($_POST['token'])) {
/*/
// use "sha256" hash for password verification, as used for the myGenghis platform (don't forget to comment the "else > error" if used!) :
if (isset($auth_users[$_POST['fm_usr']]) && isset($_POST['fm_pwd']) && (hash('sha256', $_POST['fm_pwd']) == $auth_users[$_POST['fm_usr']])) {
//*/
...
<div class="mb-3">
<div class="brand">
<img src="https://mygenghis.graphene-bsm.com/classes/genghis/logo.png" alt="myGenghis" width="80" height="80" />
</div>
...
&mdash;&mdash; &copy;
<a href="https://mygenghis.graphene-bsm.com" target="_blank" class="text-muted" data-version="<?php echo VERSION; ?>">myGenghis by Graphene-BSM LTD</a> &mdash;&mdash;
</div>
</div>
</div>
</div>
...
<p><h3><a href="https://mygenghis.graphene-bsm.com" target="_blank" class="app-v-title"> myGenghis Open-Code</a></h3></p>
<p>Author: Graphene-BSM LTD</p>
<p>Mail Us: <a href="mailto:info@graphene-bsm.com">info[at]graphene-bsm.com</a> </p>
</div>
<div class="col-xs-12 col-sm-6">
<div class="card">
<ul class="list-group list-group-flush">
<!-- must UPDATE to final myGenghis links/access -->
<li class="list-group-item"><a href="https://mygenghis.graphene-bsm.com/classes/livezilla/knowledgebase.php?etc=IzJhMmIyZA__&no-logo=MQ__&ptl=FR" target="_blank"><i class="fa fa-question-circle"></i> <?php echo lng('Help Documents') ?> </a> </li>
<li class="list-group-item"><a href="https://mygenghis.graphene-bsm.com/classes/livezilla/chat.php?v=2&linkid=MDUzNTIxYjI5MTVkMDY5MTcxMmRkNjhhNDM1M2ViZWM_" target="_blank"><i class="fa fa-bug"></i> <?php echo lng('Report Issue') ?></a></li>
...
class="edit-file"><i class="fa fa-pencil-square-o"></i> <?php echo lng('Edit') /*lng('AdvancedEditor')*/ ?>
</a></b> &nbsp;
<?php } ?>
